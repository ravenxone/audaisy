...
export type ApiErrorCode = "INVALID_REQUEST" | "PROJECT_NOT_FOUND" | "CHAPTER_NOT_FOUND" | "RENDER_JOB_NOT_FOUND" | "RENDER_JOB_NOT_READY" | "UNSUPPORTED_IMPORT_TYPE" | "MALFORMED_IMPORT" | "MODEL_HARDWARE_UNSUPPORTED" | "MODEL_DISK_SPACE_LOW" | "MODEL_MANIFEST_FETCH_FAILED" | "MODEL_MANIFEST_INVALID" | "MODEL_DOWNLOAD_FAILED" | "MODEL_CHECKSUM_MISMATCH" | "MODEL_NOT_READY" | "MODEL_LOAD_FAILED" | "VOICE_PRESET_NOT_FOUND" | "VOICE_REFERENCE_MISSING" | "RENDER_GENERATION_FAILED";
